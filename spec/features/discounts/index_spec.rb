...
RSpec.describe 'discount index page' do 
  ...
  it 'lists all discounts and has a link to discount show page', :vcr do 
  ...
  it 'has link to delete each discount', :vcr do
    visit merchant_discounts_path(merchant_1.id)
  ...
  it 'has section for upcoming holidays', :vcr do
    visit merchant_discounts_path(merchant_1.id)
